...
# The script uses a fixed seed (SeedSequence(123456789)), 
# which means it will generate the exact same "random" data every time it's run. 
...
def simulate_ride_distances():
    ...
    ride_dists = np.concatenate(
        (
            ...
            30 * np.random.random(size=10),  # long distances for outiers
